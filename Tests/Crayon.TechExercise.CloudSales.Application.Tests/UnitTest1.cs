...
//            A.CallTo(() => _ccpClient.GetSoftwareListAsync()).Returns(new List<SoftwareDto>());
...
//                .Returns(new List<SoftwareDto> { new() { Id = 1, Name = "Test Software" } });
//            A.CallTo(() => _accountRepository.GetAccount(1)).Returns((AccountDto?)null);
...
//            var software = new SoftwareDto { Id = 5, Name = "AWS" };
//            var account = new AccountDto { Id = 10 };

//            A.CallTo(() => _validator.Validate(command)).Returns(new ValidationResult());
//            A.CallTo(() => _ccpClient.GetSoftwareListAsync()).Returns(new List<SoftwareDto> { software });
